...
from ai_studio_core.task_manager import TaskManager
from ai_studio_core.task_models import Task
...
class TestLoop:
    def test_loop_cancelled_before_start(self, task_manager):
        ...
        with patch("ai_studio_core.task_manager.run_tts") as mock_run:
    ...
    def test_loop_success(self, task_manager):
        ...
        with patch("ai_studio_core.task_manager.run_tts", side_effect=fake_run_tts):
            task_manager.q.put(task)
            task_manager.running = True
    ...
    def test_loop_error(self, task_manager):
        ...
        with patch("ai_studio_core.task_manager.run_tts", side_effect=fake_run):
            task_manager.q.put(task)
            task_manager.running = True
