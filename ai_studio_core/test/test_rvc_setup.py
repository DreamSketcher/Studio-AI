...
import ai_studio_core.env_core.rvc_setup as rvc
...
class TestDetectTorchBuild:
    ...
    def test_not_installed_fallback_cpu(self, tmp_env, monkeypatch):
        ...
        monkeypatch.setattr(
            "ai_studio_core.env_core.torch_setup._pick_torch_variant",
            lambda gpu: ("cpu", "https://download.pytorch.org/whl/cpu"),
        )
        monkeypatch.setattr("ai_studio_core.env_core.cpu_gpu.detect_gpu", lambda: {"vendor": "unknown"})
...
class TestRunPipCapture:
    def test_capture(self, tmp_env, monkeypatch):
        ...
        monkeypatch.setattr(
            "ai_studio_core.env_core.diagnostics._read_pip_output",
