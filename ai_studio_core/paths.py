...
# Если какой-то модуль делает: from ai_studio_core.paths import SOMETHING_UNKNOWN
...
def __getattr__(name: str):
    ...
    Позволяет импортировать любое имя из ai_studio_core.paths без ImportError.
    """
    # 1. явный fallback
