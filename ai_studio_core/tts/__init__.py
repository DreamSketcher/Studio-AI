...
from ai_studio_core.prosody_layer import create_prosody_layer
from ai_studio_core.word_replacer import WordReplacer
from ai_studio_core.text_utils import is_list_item as _is_list_item
...
from ai_studio_core.smart_pauses import SmartPauseEngine
from ai_studio_core.reference_processor import ReferenceProcessor
from ai_studio_core.de_esser import create_de_esser
...
def get_rvc_processor():
    ...
    with _rvc_lock:
        if _rvc_processor is None:
            from ai_studio_core.rvc_pipeline import RVCPostProcessor
        ...
        for i, chunk in enumerate(chunks):
            ...
            try:
                ...
                if rvc_enable and rvc_model:
                    try:
                        from ai_studio_core.rvc_pipeline import RVCPipelineError
