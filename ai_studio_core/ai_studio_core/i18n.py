...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "hub_size": "Size:",
        "hub_deleted": "Deleted:",
        "hub_delete_fail": "Could not delete model file",
        "hub_download_fail": "Download failed",
        "hub_download_done": "Downloaded:",
        "dlg_download_title": "Download RVC model",
        "dlg_catalog_empty": "Catalogue is unavailable offline — no remote entries to download.",
        "proj_saved": "Project saved:",
        "proj_loaded": "Project loaded:",
        "proj_new_done": "New project created",
        "proj_fail": "Project file error",
        ...
        "set_llm": "LLM Provider",
        "set_provider": "Provider:",
        "set_api_key": "API key:",
        "set_api_key_ph": "Paste the API key…",
        "set_save": "Save",
        "set_key_state_ok": "key configured ✓",
        "set_key_state_missing": "key not set",
        "set_key_saved": "LLM settings saved",
        "model_auto": "Auto (recommended)",
        "prov_engines": "Local engines",
        ...
        "ctl_backend_missing": "Selected TTS backend is not available",
        ...
        "ctl_llm_missing": "No LLM client configured: pick a provider and paste the API key in Settings → LLM Provider.",
    ...
    "ru": {
        ...
        "hub_size": "Размер:",
        "hub_deleted": "Удалено:",
        "hub_delete_fail": "Не удалось удалить файл модели",
        "hub_download_fail": "Ошибка скачивания",
        "hub_download_done": "Скачано:",
        "dlg_download_title": "Скачивание RVC-модели",
        "dlg_catalog_empty": "Каталог недоступен без сети — скачивать нечего.",
        "proj_saved": "Проект сохранён:",
        "proj_loaded": "Проект загружен:",
        "proj_new_done": "Создан новый проект",
        "proj_fail": "Ошибка файла проекта",
        ...
        "set_llm": "LLM-провайдер",
        "set_provider": "Провайдер:",
        "set_api_key": "API-ключ:",
        "set_api_key_ph": "Вставьте API-ключ…",
        "set_save": "Сохранить",
        "set_key_state_ok": "ключ настроен ✓",
        "set_key_state_missing": "ключ не задан",
        "set_key_saved": "Настройки LLM сохранены",
        "model_auto": "Авто (рекомендуется)",
        "prov_engines": "Локальные движки",
        # ── Controllers / messages ──
        ...
        "ctl_backend_missing": "Выбранный TTS-бэкенд недоступен",
        ...
        "ctl_llm_missing": "LLM-клиент не настроен: выберите провайдера и введите API-ключ в Настройки → LLM-провайдер.",
