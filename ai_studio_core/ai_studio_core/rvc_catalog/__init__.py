...
ВНИМАНИЕ: импортный путь `from ai_studio_core import rvc_catalog` и все имена, которые
...
from ai_studio_core.rvc_catalog import _constants as _constants  # noqa: F401

# ── Константы и пути (источник: _constants) ──────────────────────────────────
from ai_studio_core.rvc_catalog._constants import (  # noqa: F401
    BASE_DIR,
    SEED_CATALOG_PATH,
    RVC_MODELS_DIR,
...
# ── sources.py ─────────────────────────────────────────────────────────────────
from ai_studio_core.rvc_catalog.sources import (  # noqa: F401
    _validate_catalog,
    _load_local_catalog,
...
# ── downloader.py ──────────────────────────────────────────────────────────────
from ai_studio_core.rvc_catalog.downloader import (  # noqa: F401
    local_model_path,
    is_downloaded,
    _gdrive_file_id,
...
# ── preview.py ─────────────────────────────────────────────────────────────────
from ai_studio_core.rvc_catalog.preview import (  # noqa: F401
    _PreviewAudioParser,
    _entry_page_url,
    can_preview,
...
# ── metadata.py ────────────────────────────────────────────────────────────────
from ai_studio_core.rvc_catalog.metadata import (  # noqa: F401
...
# ── cache.py ───────────────────────────────────────────────────────────────────
from ai_studio_core.rvc_catalog.cache import (  # noqa: F401
