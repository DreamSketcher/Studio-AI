...
объект пакета (`import ai_studio_core.rvc_catalog as _pkg`), чтобы тестовый monkeypatch
оставался рабочим.
"""
...
from ai_studio_core.updater import _urlopen_with_retry, _is_cancelled
