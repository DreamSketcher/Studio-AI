...
доверия RVC-чекпоинта к SHA-256 (делегируется ai_studio_core.rvc_pipeline).
...
from ai_studio_core import rvc_catalog as _pkg
from ai_studio_core.rvc_catalog import _constants as _C
import contextlib
...
def is_local_model_trusted(name: str) -> bool:
    from ai_studio_core.rvc_pipeline import is_rvc_checkpoint_trusted
...
def trust_local_model(name: str, source: str = "user-confirmed") -> str:
    from ai_studio_core.rvc_pipeline import mark_rvc_checkpoint_trusted
