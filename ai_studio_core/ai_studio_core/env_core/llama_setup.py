...
from ai_studio_core.env_core.cpu_gpu import detect_cpu, detect_gpu
...
def get_startup_install_state() -> dict:
    ...
    from ai_studio_core.env_core.diagnostics import get_install_activity_status
...
def install_llama_cpp(
    ...
    from ai_studio_core.env_core.diagnostics import get_python_env_info, format_env_info
