...
def _pick_torch_variant(gpu_info: dict) -> tuple:
    try:
        from ai_studio_core.settings_store import load_settings
...
def install_torch(progress_cb=None, resume: bool = False, variant: str = None) -> dict:
    ...
    from ai_studio_core.env_core.install_state import (
...
def cancel_install_torch() -> bool:
    ...
    from ai_studio_core.env_core.install_state import _release_install_lock, _set_install_cancelled
