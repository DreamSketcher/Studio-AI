...
from ai_studio_core.reference_processor import AdaptiveSilenceTrimmer, ReferenceProcessor, SNRAnalyzer
...
class TestReferenceProcessor:
    ...
    def test_process_reference_already_normalized(self, tmp_library, tmp_path):
        ...
        with patch("ai_studio_core.reference_processor.AudioSegment.from_file") as mock_from_file:
            mock_seg = MagicMock()
    ...
    def test_process_reference_pipeline_mocked(self, tmp_library, tmp_path):
        ...
        with patch("ai_studio_core.reference_processor.AudioSegment.from_file") as mock_from:
            mock_seg = MagicMock()
